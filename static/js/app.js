...
let data = d3.json(url).then(function(data){
    ...
    function updateCharts(selectedSample) {
        ...
        // Sort data in descending order by sample values (major chatGPT help)
        ...
        let barLayout = {
            ...
            // I am being cheeky since I can't figure out how to properly display it in descending order
